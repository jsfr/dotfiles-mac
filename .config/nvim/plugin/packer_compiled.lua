...
_G.packer_plugins = {
  ...
  ["vim-fugitive"] = {
    loaded = true,
    path = "/Users/jens/.local/share/nvim/site/pack/packer/start/vim-fugitive",
  ...
  ["vim-sexp"] = {
    loaded = true,
    path = "/Users/jens/.local/share/nvim/site/pack/packer/start/vim-sexp",
    url = "https://github.com/guns/vim-sexp"
  },
  ["vim-sexp-mappings-for-regular-people"] = {
    config = { "\27LJ\2\nZ\0\0\2\0\4\0\0066\0\0\0009\0\1\0'\1\3\0=\1\2\0+\0\0\0L\0\2\0*clojure,scheme,lisp,timl,fennel,janet\19sexp_filetypes\6g\bvim\0" },
    loaded = true,
    path = "/Users/jens/.local/share/nvim/site/pack/packer/start/vim-sexp-mappings-for-regular-people",
