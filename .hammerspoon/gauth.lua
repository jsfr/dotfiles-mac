...
function GAuth.GenCode(in_skey, in_value)
    local skey = basexx.from_base32(in_skey)
    local value = string.char(
        0, 0, 0, 0,
        band(in_value, 0xFF000000) / 0x1000000,
        band(in_value, 0xFF0000) / 0x10000,
        band(in_value, 0xFF00) / 0x100,
        band(in_value, 0xFF))
